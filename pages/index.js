    ...
    <>
      ...
      <section id="services" className={styles.section}>
        ...
        <div className={styles.grid}>
          <div className={styles.card}><h3>Nail Art</h3><p>Créations strass, marbre, dessins exclusifs.</p></div>
          ...
          <div className={styles.card}><h3>Pack Signature</h3><p>Chablon + gel + nail art minimal chic (-15 %).</p></div>
        </div>
      </section>
      ...
      <footer className={styles.footer}>
        Rue de la Poste, Khezema, Sousse — Mardi → Dimanche 10 h – 20 h<br/>
